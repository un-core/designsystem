...
| `accent`           | very important actions and only once or twice on each page **Outdated:** Do not use anymore! |
...
<Callout title="Accent button outdated" kind="warning">
  Do not use the accent button anylonger.
</Callout>
