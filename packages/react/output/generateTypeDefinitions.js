...
var reactDocgenTypescript = require('react-docgen-typescript');
...
var distUrl = path.resolve(__dirname, "../../website/types/");
var options = {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    fileList = [];
                    return [4 /*yield*/, promises.readdir(directory)];
                case 1:
                    files = _b.sent();
                    _i = 0, files_1 = files;
                    _b.label = 2;
                case 2:
                    ...
                    return [4 /*yield*/, promises.stat(p)];
                case 3:
                ...
                case 7:
                    ...
                    return [4 /*yield*/, Promise.all(tsxFileList.map(function (file) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        propTypes = JSON.parse(JSON.stringify(reactDocgenTypescript.parse(file, options)));
                                        _a.label = 1;
                                    case 1:
                                        _a.trys.push([1, 3, , 4]);
                                        return [4 /*yield*/, promises.mkdir(path.dirname(path.join(distUrl, file)), {
                                                recursive: true
                                            })];
                                    case 2:
                                        _a.sent();
                                    ...
                                    case 3:
                                        ...
                                        return [3 /*break*/, 4];
                                    case 4: return [4 /*yield*/, promises.writeFile(path.join(distUrl, file.replace(".tsx", ".json")), JSON.stringify(propTypes, null, 2))];
                                    case 5:
                                        _a.sent();
...
function startGenerateTypes() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, promises.rm(distUrl, { recursive: true, force: true })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, walk("./src/components/Link")];
                case 2:
                    _a.sent();
                    process.exit();
                    return [2 /*return*/];
